...
calculating progress. The CSV file is reloaded every 5 minutes in a background thread.
...
def update_data_periodically():
    """
    Periodically update the data by downloading the latest CSV file and reloading it.
    """
    global data
    while True:
        with data_lock:
...
def index():
    ...
    return render_template('index.html', data=current_data, last_updated=last_updated)
